...
const months = ["Default", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
...
let birthdayString = prompt("Enter date of your next birthday in the format mm-dd-yyyy: ");
...
function birthdayCountdown (birthdayString) {
 ...
 console.log("Q25: ", birthdayCountdown(birthdayString), "days to your birthday");
