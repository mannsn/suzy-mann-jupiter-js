...
// PUT YOUR CODE HERE
let aboutPet = `It is an ${myPet.color} ${myPet.species} named ${myPet.name}`;
console.log("Q2: ", aboutPet);
...
const isDog = (param) => {
  ...
  return param.species == speciesChecker;
};
console.log("Q4: ", isDog(myPet));
...
const sortArray = (json) => json.toSorted((a, b) => a.libraryID - b.libraryID);
console.log("Q5: ", sortArray(library));
...
// PUT YOUR CODE HERE
const addNewObject = (arr, obj) => arr.push(obj) && arr;
console.log(
  "Q7: ",
